...
if hora_atual < 12 and hora_atual > 6:
    if datetime.today().weekday() == 4:
        fernanda.say(
            f'SEXTOOOOU! Bom dia, {nome_usuario}! Como posso te ajudar?')
    elif datetime.today().weekday() == 5:
        fernanda.say(
            f'SABADOUU! Bom dia, {nome_usuario}! Como posso te ajudar?')
    else:
    ...
    if datetime.today().weekday() == 4:
        fernanda.say(
            f'SEXTOOOOU! Boa tarde, {nome_usuario}! Como posso te ajudar?')
    elif datetime.today().weekday() == 5:
        fernanda.say(
            f'SABADOUU! Boa tarde, {nome_usuario}! Como posso te ajudar?')
    else:
    ...
    if datetime.today().weekday() == 4:
        fernanda.say(
            f'SEXTOOOOU! Boa noite, {nome_usuario}! Como posso te ajudar?')
    elif datetime.today().weekday() == 5:
        fernanda.say(
            f'SABADOUU! Boa noite, {nome_usuario}! Como posso te ajudar?')
    else:
...
# TOPICO DE PESQUISA / PROCURA ===============================================================
        ...
        fernanda.runAndWait()
        procurar = palavras.replace('procure', '').replace(
            'encontre', '').replace('pesquise', '').replace('o que é', '')
...
# TOPICO DE PESQUISA / PROCURA ===============================================================
    ...
    #YOUTUBE (VIDEOS)
    # TODO MUDAR AS CONDIÇÕES PARA ELA REPRODUZIR VIDEO
    elif termo_existe(['toque', 'tocar', 'musica'], palavras):
        # TODO ADICIONAR VARIAS FALAS PARA QUANDO FOR REPRODUZIR VIDEO
        fernanda.say('Como quiser chefia!')
        fernanda.runAndWait()
